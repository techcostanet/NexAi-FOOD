const prodMap: Record<string, string> = {
  'Arroz': 'prod-1',
  'Frango Grelhado': 'prod-2',
  'Feijao': 'prod-3',
  'Pao Frances': 'prod-4',
  'Macarrao': 'prod-5',
  'Carne Bovina': 'prod-6',
  'Salada Verde': 'prod-7',
  'Suco de Laranja': 'prod-8',
};

const areaMap: Record<string, string> = {
  'Cozinha Quente': 'area-1',
  'Pré-Preparo / Saladas': 'area-2',
  'Buffet / Balcão': 'area-3',
  'Padaria / Lanches': 'area-4',
  'Sucos / Bebidas': 'area-5',
};

const parseIsoDate = (dStr: string) => {
...
export const initialDataCloud = {
  ...
  areas: [
    { id: 'area-1', nome: 'Cozinha Quente' },
    { id: 'area-2', nome: 'Pré-Preparo / Saladas' },
    { id: 'area-3', nome: 'Buffet / Balcão' },
    { id: 'area-4', nome: 'Padaria / Lanches' },
    { id: 'area-5', nome: 'Sucos / Bebidas' },
  ],

  products: [
    { id: 'prod-1', nome: 'PÃO DOCE SEM MARGARINA - MANHÃ', unidade: 'un', custo_unitario: 0.60, ativo: true },
    { id: 'prod-2', nome: 'PÃO DOCE COM MARGARINA - MANHÃ', unidade: 'un', custo_unitario: 0.69, ativo: true },
    { id: 'prod-3', nome: 'PÃO DE SAL COM MARGARINA - MANHÃ', unidade: 'un', custo_unitario: 0.69, ativo: true },
    { id: 'prod-4', nome: 'PÃO DOCE SEM MARGARINA - TARDE', unidade: 'un', custo_unitario: 0.60, ativo: true },
    { id: 'prod-5', nome: 'PÃO DOCE COM MARGARINA - TARDE', unidade: 'un', custo_unitario: 0.69, ativo: true },
    { id: 'prod-6', nome: 'PÃO DE SAL COM MARGARINA - TARDE', unidade: 'un', custo_unitario: 0.69, ativo: true },
    { id: 'prod-7', nome: 'MARMITEX PACIENTE - ALMOÇO', unidade: 'un', custo_unitario: 19.33, ativo: true },
    { id: 'prod-8', nome: 'MARMITEX PACIENTE - JANTAR', unidade: 'un', custo_unitario: 19.33, ativo: true },
    { id: 'prod-9', nome: 'SOPA PACIENTE - ALMOÇO', unidade: 'un', custo_unitario: 19.33, ativo: true },
    { id: 'prod-10', nome: 'SOPA PACIENTE - JANTAR', unidade: 'un', custo_unitario: 19.33, ativo: true },
    { id: 'prod-11', nome: 'MARMITEX COLABORADOR - ALMOÇO', unidade: 'un', custo_unitario: 19.33, ativo: true },
  ],
